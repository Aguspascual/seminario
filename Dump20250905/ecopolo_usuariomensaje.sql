...
CREATE TABLE `usuariomensaje` (
  ...
  PRIMARY KEY (`Usuario_Legajo`,`Mensaje_idMensaje`),
  KEY `fk_Usuario_has_Mensaje_Mensaje1_idx` (`Mensaje_idMensaje`),
  KEY `fk_Usuario_has_Mensaje_Usuario1_idx` (`Usuario_Legajo`),
  CONSTRAINT `fk_Usuario_has_Mensaje_Mensaje1` FOREIGN KEY (`Mensaje_idMensaje`) REFERENCES `mensaje` (`idMensaje`),
  CONSTRAINT `fk_Usuario_has_Mensaje_Usuario1` FOREIGN KEY (`Usuario_Legajo`) REFERENCES `usuario` (`Legajo`)
